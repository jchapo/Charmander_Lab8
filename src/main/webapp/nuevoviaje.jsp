...
<head>
  ...
  <style>
    body {
      background-image: url("resources/assets/images/vuelo.jpg");
...
<div class="container table-container">
  ...
  <form method="POST" action="ServletViajes">
    ...
    <div class="form-group">
      ...
      <input type="text" id="fecha-viaje" class="form-control" placeholder="Selecciona una fecha" name="fecha-viaje" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="number" id="cantidad-boletos" name="cantidad-boletos" class="form-control" name="cantidad-boletos" required min="0">
    </div>
